 ...
 * Description: Issues complimentary Tickera tickets without a checkout. Creates a real WooCommerce order, records the retail value forgone as a 100% comp discount, and calls the Tickera Bridge's own ticket factory directly so a genuine ticket PDF is generated. Two front doors are planned on this engine: an admin issue button for individual comps, and a Singers Portal claim panel for group allowances. v0.1.0 ships the engine and a diagnostics route only.
 * Version:     0.1.0
